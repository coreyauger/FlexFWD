 ...
 * hidden           - id of hidden field to put values in for asp.net postback
 */
            ...
            return this.each(function() {
                ...
                function addItem(title, value, preadded) {
                    ...
                    if (!preadded) {
                        ...
                        // TODO: a cache.pop
                        var selStr = '';
                        element.children('.selected').each(function(ind, elm) {
                            selStr += $(elm).val() + ",";
                        });
                        $('#' + options.hidden).val(selStr);
                        //alert($('#' + options.hidden).val());
                    }
                    ...
                    input.keyup(
	                    function(event) {
	                        ...
	                        if (event.keyCode != 40 && event.keyCode != 38 && etext.length != 0) {
	                            ...
	                            Affine.WebService.StreamService.searchFriends(Aqufit.Page.UserId, Aqufit.Page.PortalId, etext, function(data) {
	                                data = eval('(' + data + ')');
