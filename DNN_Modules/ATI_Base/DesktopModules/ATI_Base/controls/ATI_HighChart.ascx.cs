...
public partial class DesktopModules_ATI_Base_controls_ATI_HighChart : DotNetNuke.Framework.UserControlBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            atiHighChartPanel.Height = this.Height;
            atiHighChartPanel.Width = this.Width;

            if (this.Visible)
            {
                ScriptManager.RegisterStartupScript(this, Page.GetType(), "AtiHighChart", GetChartData(), true);
            }
        }
    }
    ...
    private string GetChartData()
    {
        ...
        js += "Aqufit.Page." + this.ID + " = new Aqufit.Page.Controls.ATI_HighChart('"+this.ID+"'); ";
